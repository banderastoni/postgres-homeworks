...
-- 2. идентификатор заказа и разницу между датами формирования (order_date) заказа и его отгрузкой (shipped_date)
-- из таблицы orders
SELECT order_id, shipped_date - order_date as difference_days
FROM orders;
